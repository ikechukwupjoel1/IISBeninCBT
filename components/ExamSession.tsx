        ...
        <div className="flex items-center gap-4">
            ...
            <div className="border-l border-brand-700 pl-4">
                ...
                <div className="text-xs text-brand-300 mt-1 flex gap-3 font-medium">
                    ...
                    <span>&bull;</span>
                    <span className="opacity-80">Candidate: {student.regNumber}</span>
                </div>
            </div>
        </div>
            ...
            <Card className="p-12 min-h-[500px] flex flex-col justify-center shadow-material-lg border-0 relative overflow-hidden">
              ...
              <div className="space-y-4 max-w-3xl">
                {currentQuestion.type === QuestionType.MULTIPLE_CHOICE && currentQuestion.options?.map((opt) => (
                  <label 
                    key={opt}
                    className={`group flex items-center p-5 rounded-2xl border-2 cursor-pointer transition-all duration-200 ${
                  ...
                  <div className="flex flex-col sm:flex-row gap-6">
                     {['True', 'False'].map((opt) => {
                       ...
                       return (
                        <label 
                          key={opt}
                          className={`flex-1 flex items-center justify-center p-8 rounded-2xl border-2 cursor-pointer transition-all ${
